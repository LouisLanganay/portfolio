    ...
    <Dialog open={isOpen} as='div' className='relative z-10 focus:outline-hidden' onClose={onClose}>
      ...
      <div className='fixed inset-0 z-50 w-screen overflow-y-auto'>
        <div className='flex min-h-full items-center justify-center p-4'>
          <DialogPanel
            transition
            className='max-w-lg w-full h-fit relative bg-tertiary-600 rounded-lg shadow-sm ring-1 ring-tertiary-480 pb-6 px-3 pt-4 text-center flex flex-col items-center transition data-closed:transform-[scale(95%)] data-closed:opacity-0'
          >
