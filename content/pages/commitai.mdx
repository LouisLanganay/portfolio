...
tools: [typescript]
image: /preview/commit-ai-generator.png
date: 04 oct. 2023
...
<div className="flex flex-row justify-between w-fit gap-2">
  <img
    src="https://vsmarketplacebadges.dev/installs/Coodo.commit-generator.svg"
    style={{ height: "20px", width: "66px" }}
    alt="Installs"
  />
  <img
    src="https://vsmarketplacebadges.dev/rating-star/Coodo.commit-generator.svg"
    style={{ height: "20px", width: "108px" }}
    alt="Rating"
  />
</div>
