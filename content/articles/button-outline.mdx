...
- `bg-gradient-to-r from-[#feca77] to-[#fed1b3]`: Applies a horizontal gradient
- `text-[#171717]`: Sets the text color
- `hover:bg-opacity-80`: Slightly reduces opacity on hover
- `ring-[1px] ring-[#feca77]/50`: Adds an outer ring with 50% opacity
- `ring-offset-[3px] ring-offset-[#121212]`: Creates a ring offset
